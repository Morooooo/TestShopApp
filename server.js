...
const storeItems=new Map([
  [1,{name:'CSKA_FC-cap',price:22}],
  [2,{name:'Slavia_FC-cap',price:13}],
  [3,{name:'Beroe_FC-cap',price:12}]  
])
var selectedItems=[]
...
app.get('/:params',(req,res)=>{
    res.render(req.url.split('/')[1],{paypalClientId:process.env.PAYPAL_CLIENT_ID
    })
})
...
console.log(req.session.shoppingData)
...
//console.log(session.shoppingData)
